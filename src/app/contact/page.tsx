...
export const metadata = {
  ...
  keywords: 'contact TsvWeb, web design contact, web development services, contact form, get a quote',
}
...
export default function Contact() {
  return (
    <main className="min-h-screen flex flex-col">
      ...
      <section className="section-padding bg-white dark:bg-gray-900">
        <div className="container-custom">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Contact Information */}
            <div>
              <h2 className="heading-2 text-gray-900 dark:text-white mb-6">Get In Touch</h2>
              
              <div className="space-y-8">
                <div className="flex items-start">
                  <div className="flex-shrink-0">
                    <svg className="w-6 h-6 text-royal-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 mt-1">info@tsvweb.com</p>
                    <p className="text-gray-600 dark:text-gray-400 text-sm mt-1">We'll respond as soon as possible</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 mt-1">123 Web Design Street</p>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 mt-1">Monday-Friday: 9am-5pm</p>
              ...
              <div className="mt-10">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="text-gray-500 hover:text-royal-blue dark:hover:text-royal-blue-light">
            ...
            {/* Contact Form */}
            <div>
              <h2 className="heading-2 text-gray-900 dark:text-white mb-6">Send Us a Message</h2>
              <ContactForm />
            </div>
          </div>
        </div>
      ...
      {/* Map Section */}
      <section className="h-96 bg-gray-200 dark:bg-gray-800 relative">
