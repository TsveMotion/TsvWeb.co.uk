...
export default function TradesPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col">
      <PageSEO 
        title="Website Design for Tradespeople in Birmingham | Builders, Electricians, Plumbers"
        description="Professional websites for Birmingham tradespeople. Get more calls and quotes with a fast, mobile-friendly website. Affordable monthly plans from £30/month."
        canonical="https://tsvweb.com/trades"
        openGraph={{
          title: "Websites Built for Birmingham Tradesmen | TsvWeb",
          description: "Fast, affordable websites for builders, electricians, plumbers, and roofers in Birmingham. Built to bring you more calls and quotes.",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <motion.div className="text-center lg:text-left" {...fadeInUp}>
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-6 leading-tight">
                Websites Built for <span className="text-royal-blue">Birmingham Tradesmen</span>
              </h1>
              <p className="text-lg sm:text-xl md:text-2xl text-gray-700 dark:text-gray-300 mb-6 sm:mb-8 leading-relaxed">
                Fast, affordable, and built to bring you more calls and quotes.
              </p>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-lg text-gray-700 dark:text-gray-300 max-w-3xl mx-auto">
              We understand tradespeople. No jargon, no fuss – just websites that work.
            </p>
          </motion.div>
