    ...
    <main className="min-h-screen flex flex-col bg-white dark:bg-gray-900">
      ...
      <div className="container-custom py-24">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-black text-gray-900 dark:text-white mb-8">Privacy Policy</h1>
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-12">
              ...
              <h3 className="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-3 mt-6">Personal Data</h3>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
              ...
              <h3 className="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-3 mt-6">Automatically Collected Information</h3>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            ...
            <section className="mb-12">
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">4. Legal Basis for Processing (GDPR)</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            ...
            <section className="mb-12">
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">5. Sharing Your Information</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            ...
            <section className="mb-12">
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">6. Cookies and Tracking Technologies</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            ...
            <section className="mb-12">
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">7. Data Security</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <section className="mb-12">
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">8. Data Retention</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <section className="mb-12">
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">9. Your Rights</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
            ...
            <section className="mb-12">
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">10. Third-Party Links</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <section className="mb-12">
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">11. Children's Privacy</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <section className="mb-12">
              ...
              <div className="bg-blue-50 dark:bg-gray-800 p-6 rounded-lg border-l-4 border-[#007BFF]">
                ...
                <p className="text-gray-700 dark:text-gray-300">Address: Birmingham, United Kingdom</p>
              </div>
            </section>
          </div>
        </div>
