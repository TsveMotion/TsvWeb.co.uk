...
export default function AIBlogGenerator({ onBlogGenerated }: AIBlogGeneratorProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const generatedBlog = await AIService.generateBlogContent(generationRequest);
    ...
    <div className="bg-white dark:bg-gray-800 shadow overflow-hidden sm:rounded-lg">
      <div className="px-4 py-5 sm:px-6">
        ...
        <p className="mt-1 max-w-2xl text-sm text-gray-500 dark:text-gray-400">
          Generate blog content about web design using GPT-4o
        </p>
      </div>
        ...
        <form onSubmit={handleSubmit} className="px-4 py-5 sm:p-6">
          ...
          <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
            <div className="sm:col-span-6">
              ...
              <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Enter a specific topic for your blog post about web design
              </p>
            </div>
          ...
          <div className="mt-6">
            <button
              ...
              className="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-royal-blue hover:bg-royal-blue-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-royal-blue disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {isGenerating ? (
                <>
